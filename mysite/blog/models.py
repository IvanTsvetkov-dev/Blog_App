...
class Post(models.Model):
    ...
    slug = models.SlugField(max_length=250, unique_for_date='publish') # Проверка на уникальность будет только по дате 
...
class Comment(models.Model):
    ...
    def __str__(self):
        return f'Комментировал {self.name} пост {self.post}'
